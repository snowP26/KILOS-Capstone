        ...
        >
            ...
            <div className="flex flex-col gap-5 mt-3 lg:flex-row mx-10">
                ...
                <div className="mt-5 md:gap-2 flex flex-col justify-around sm:ml-10 md:ml-0">
                    <strong className={`text-balance font-medium mb-5 sm:mb-0 line-clamp-2 ${file && "group-hover:text-blue-800"} transition-colors`}>
                        {description}
                    </strong>
                    <span className={`font-medium line-clamp-2 text-gray-700 ${file && "group-hover:text-blue-900"}  transition-colors`}>
                        Ordinance {title}
                    </span>
                </div>
            </div>
            ...
            <div className="flex flex-row mt-8 mb-2 pb-4 ml-10 text-xs sm:text-sm">
                ...
                <p className={`italic text-gray-600 ${file && "group-hover:text-gray-800"}  transition-colors`}>{authorName}</p>
            </div>
        </div>
    )
}
