        ...
        <div className="bg-[#E6F1FF] h-screen mt-10">
            ...
            <div className="mx-20 mt-10">
                <Table className="bg-white w-[100%]">
                    <TableCaption className="mt-2">Status of Ordinance for each Readings.</TableCaption>
                    <TableHeader>
                        <TableRow>
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell> 
                                <p className="text-center font-medium bg-[#052659] rounded-2xl text-white">Approved</p>
                            </TableCell>
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell> 
                                <p className="text-center font-medium bg-[#052659] rounded-2xl text-white">In Progress</p>
                            </TableCell>
                            <TableCell className="text-center italic">January 11, 2000</TableCell>
                            <TableCell className="text-center italic">March 10, 2000</TableCell>
                            <TableCell className="text-center">Local Youth Development Office</TableCell>
                    ...
                    <TableBody>
                        <TableRow>
                            ...
                            <TableCell> 
                                <p className="text-center font-medium bg-[#052659] rounded-2xl text-white">Pending</p>
                            </TableCell>
                            <TableCell className="text-center italic">March 11, 2000</TableCell>
                            <TableCell className="text-center italic">April 1, 2000</TableCell>
                            <TableCell className="text-center">-</TableCell>
                            <TableCell className="text-center">-</TableCell>
                        </TableRow>
                    </TableBody>
            ...
            <div className="mx-20 mt-10">
                <p className="font-semibold text-xl pt-5">Ordinance Document</p>
                    <p className="text-gray-500 italic text-md">Please submit the PDF of the ordinance or any necessary documents.</p>
                <div className="w-55 mt-2">
                    <Input type="file" className="bg-white cursor-pointer hover:bg-gray-300"/>
                </div>
            </div>
