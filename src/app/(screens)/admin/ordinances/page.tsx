    ...
    return (
        <div className="bg-[#E6F1FF] min-h-screen mt-10">
            ...
            <div className="mx-30 mb-3 place-self-end">
                <Button className="text-white bg-[#052659] h-10 cursor-pointer hover:bg-white hover:text-[#052659]" onClick={() => router.push("/admin/ordinances/submit-doc")}>Submit an Ordinance</Button>
            </div>
